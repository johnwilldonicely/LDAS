...
ARGUMENTS:
	...
	float setlow   : input: low-percentile cutoff (0-100, 0=skip)
	float sethigh  : input: high-percentile cutoff (0-100, 100=skip)
...
SAMPLE CALL:
	x= xf_outlier1_d(data,nn,5.0,95.0,message);
