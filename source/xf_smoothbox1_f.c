...
int xf_smoothbox1_f(float *input, float *output, size_t nn, size_t nwin1, char *message) {

	char *thisfunc="xf_smoothbox1_f\0";
	size_t ii,jj,kk,mm,nwin2,start,stop,oddnwin1=0;
	double sum,s1,s2,scale1;
