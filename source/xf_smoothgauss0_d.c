...
int xf_smoothgauss0_d(double *original,size_t arraysize,size_t index,int smooth,double *result) {
	...
	if(bb>0.0) *result= aa/bb; 	// if any weights were added, new value = weighted mean corrected by sum of weights - to account for missing bins
